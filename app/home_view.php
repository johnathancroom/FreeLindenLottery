...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="static3/styles/mini3.css">
  <link rel="icon" href="/static3/favicon.ico">
  ...
  <script type="text/javascript" src="static3/javascript/modernizr.min.js"></script>
</head>
<body>
  <?php
    if(isset($_flash))
        ...
        <div id="card-content-frame">
          <div id="card-content-wrap">    
            <div id="home" class="content">
              <img src="<?= getProfileUrl($_results["username"], true) ?>" alt="<?= $_results["display_username"]; ?>'s Profile Image" class="profile-image">
  ...
  <script type="text/javascript" src="static3/javascript/plugins.js"></script>
  <script type="text/javascript" src="static3/javascript/script.js"></script>
</body>
</html>